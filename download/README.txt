...
- Windows 10 v1809/v1909/v2004/v20H2/v21H1/v21H2/v22H2, Windows 11 v21H2/v22H2 - Component Removal requries a source image with supported cumulative update integrated.
- Windows 10 v1809/v1909/v2004/v20H2/v21H1/v21H2/v22H2, Windows 11 v21H2/v22H2 - Component Removal does not support ARM64 source images.
...
- Windows 10 v1809/v1909/v2004/v20H2/v21H1/v21H2/v22H2, Windows 11 v21H2/v22H2 - Removing Map Control breaks Photos App image information.
...
Windows 10 v2004/v20H2/v21H1/v21H2/v22H2 Client/Server Usage Order:
=============================================================
...
[D] - Integrate the required Windows Features (Except Microsoft .NET Framework 3.5) using [Integrate->Windows Features] menu.
	  ...
	  <Packs\NET6>											Microsoft .NET 6 Runtime
	  <Packs\NETCore31>										Microsoft .NET Core Runtime 3.1
	  <Packs\NetFX481>									    Microsoft .NET Framework 4.8.1 Runtime for Windows 10 v2004/v20H2/v21H1/v21H2/v22H2
	  <Packs\NetFX35\w10\<OSVersion>						Microsoft .NET Framework 3.5 Runtime
	  <Packs\OfficeUWP>										Microsoft Office Desktop UWP Apps
	  <Packs\OpenSSH\w10\<OSVersion>						Open Secure Shell (SSH) Client and Server
	  <Packs\PortableDevices\w10\<OSVersion>				Windows Mobile Portable Devices
...
[D] - Integrate the required Windows Features (Except Microsoft .NET Framework 3.5) using [Integrate->Windows Features] menu.
	  ...
	  <Packs\NET6>											Microsoft .NET 6 Runtime
	  <Packs\NETCore31>										Microsoft .NET Core Runtime 3.1
	  <Packs\NetFX481>									    Microsoft .NET Framework 4.8.1 Runtime for Windows Server 2021
	  <Packs\NetFX35\w10\<OSVersion>						Microsoft .NET Framework 3.5 Runtime
	  <Packs\OfficeUWP>										Microsoft Office Desktop UWP Apps
	  <Packs\PowerShell7>									Windows PowerShell 7.1
	  <Packs\Sidebar>										Windows Sidebar Gadget
...
Windows 11 v21H2/v22H2 Client/Server Usage Order:
=================================================
...
[D] - Integrate the required Windows Features (Except Microsoft .NET Framework 3.5) using [Integrate->Windows Features] menu.
	  ...
	  <Packs\NetFX481>									    Microsoft .NET Framework 4.8.1 Runtime for Windows 11 v21H2/v22H2
	  <Packs\OfficeUWP>										Microsoft Office Desktop UWP Apps
